...
public class HangThucPham extends HangHoa{
	...
	public static String getTieuDeThucPham() {
		return String.format("%-10s %-15s %-15s %-15s %-15s %-15s %-20s","Ma_hang","Ten_Hang","Don_Gia","So_Luong_Ton","Nha_cungcap","NgaySX","Ngay_HH");
	}
	
	@Override
	public String toString() {
		DateTimeFormatter dtf = DateTimeFormatter.ofPattern("dd/MM/yyyy");
		return String.format("%-10s %-15s %-15s %-20s ", super.toString(),nhaCungCap,dtf.format(ngaySanXuat),dtf.format(ngayHetHan));
	}
	@Override
