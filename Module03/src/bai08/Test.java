...
public class Test {
	...
	public static void main(String[] agrs) throws Exception {
		DanhMucHangHoa ds = new DanhMucHangHoa(100);
		ds.them(new HangThucPham("111", "gao", 15000, 10, "viet nam", LocalDate.of(2020, 10, 30),
				LocalDate.of(2020, 10, 31)));
		ds.them(new HangThucPham("222", "mi", 20000, 15, "hao hao", LocalDate.of(2019, 11, 30),
				LocalDate.of(2020, 11, 30)));
		ds.them(new HangSanhSu("666", "Ly su", 12000, 10, "LS", LocalDate.of(2020, 10, 20)));
		ds.them(new HangSanhSu("777", "Chen su", 13000, 9, "CS", LocalDate.of(2020, 11, 20)));
		ds.them(new HangDienMay("333", "tu lanh", 300000, 5, 30, 150));
		ds.them(new HangDienMay("444", "tivi", 500000, 6, 20, 100));
		...
		do {
			...
			System.out.println("7.Laythong tin cachang thuc pham kho ban");
			System.out.println("8.Xoa hang hoa khi biet ma hang");
			System.out.println("9.Sua thong tin don giakhi bet ma hang");
				...
				do {
					...
					case 11:
						...
						if (ds.them(new HangDienMay(maHang, tenHang, donGia, soLuongTon, thoigianBH, congSuat))) {
							...
							System.out.println(ds.getToanBoHangHoa());
						} else {
			...
			case 6:
				...
				break;
			case 7:
				System.err.println(ds.getToanBoHangHoa());
				break;
			case 8:
				/**
				 * System.out.println("Nhap ma can xoa"); sc = new Scanner(System.in); String
				 * maHang = sc.nextLine(); if(ds.xoaHangHoaKhiBietMa(maHang)) {
				 * System.out.println("Danhsach sau khi xoa");
				 * System.out.println(ds.getToanBoHangHoa()); }else { System.out.println("Khong
				 * tim thay ma can xoa"); }break;
				 **/
			case 9:
